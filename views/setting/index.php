...
$tabs = array(
    'storehouse' => array('title' => '仓库设置', 'url' => $this->createUrl('/pss/setting/storehouse'), 
            'view' => 'tabViews/storehouse', 'data'=>array()),
    
    'product' => array('title' => '产品设置', 'url' => $this->createUrl('/pss/setting/product&type=1'), 
           'view' => 'tabViews/product', 'data'=>array()),
    
    'approval' => array('title' => '审批设置', 'url' => $this->createUrl('/pss/setting/approval'), 
