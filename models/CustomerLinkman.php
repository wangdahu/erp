 ...
 */
class CustomerLinkman extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CustomerLinkman the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('customer_id, gender', 'numerical', 'integerOnly'=>true),
			...
			array('id, customer_id, name, gender , department, post, in_no, email, fax, im_no, mobile, phone, remark', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function getPhoneTypeList(){
        return array('0'=>'工作电话', '1'=>'家庭电话', '2'=>'宿舍电话');
    }
