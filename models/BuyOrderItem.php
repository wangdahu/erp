 ...
 */
class BuyOrderItem extends BillFormItem
{
	 ...
	 * @return BuyOrderItem the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
            'form' => array(self::BELONGS_TO, 'BuyOrder', 'order_id'),
	...
	public function getInQuantity(){
	    $quantity = 0;
	    foreach ($this->form->inItems as $item){
    ...
    public function getIsStoreComplete(){
        return $this->quantity == $this->getInQuantity();
    }
